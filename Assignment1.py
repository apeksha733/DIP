...
images=[input_image,grayscale_image,g_i,binary_image,bin_imgg,task_3,task_4]
heads=['input image','grayscale M1','grayscale M2','binary inbuit lib','binary without inbuilt lib','gray+binary','gray+20']
